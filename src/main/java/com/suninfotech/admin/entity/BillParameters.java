...
public class BillParameters {
	...
	public BillParameters(String id, String amount1, String amount2, String amount3, String amount4, String amount5,
			String amount6, String amount7, String amount8, String amount9, String amount10, String amount11,
			String amount12, String amount13, String amount14, String amount15, String cgstAmt1, String cgstAmt2,
			String cgstAmt3, String cgstAmt4, String cgstAmt5, String cgstAmt6, String cgstAmt7, String cgstAmt8,
			String cgstAmt9, String cgstAmt10, String cgstAmt11, String cgstAmt12, String cgstAmt13, String cgstAmt14,
			String cgstAmt15, String sgstAmt1, String sgstAmt2, String sgstAmt3, String sgstAmt4, String sgstAmt5,
			String sgstAmt6, String sgstAmt7, String sgstAmt8, String sgstAmt9, String sgstAmt10, String sgstAmt11,
			String sgstAmt12, String sgstAmt13, String sgstAmt14, String sgstAmt15, String igstAmt1, String igstAmt2,
			String igstAmt3, String igstAmt4, String igstAmt5, String igstAmt6, String igstAmt7, String igstAmt8,
			String igstAmt9, String igstAmt10, String igstAmt11, String igstAmt12, String igstAmt13, String igstAmt14,
			String igstAmt15, String totalBillPay, String parameterName1, String parameterName2, String parameterName3,
			String parameterName4, String parameterName5, String parameterName6, String parameterName7,
			String parameterName8, String parameterName9, String parameterName10, String parameterName11,
			String parameterName12, String parameterName13, String parameterName14, String parameterName15,
			String rebateAmount) {
		super();
		this.id = id;
	...
	public String toString() {
		return "BillParametersDTO [id=" + id + ", amount1=" + amount1 + ", amount2=" + amount2 + ", amount3=" + amount3
				+ ", amount4=" + amount4 + ", amount5=" + amount5 + ", amount6=" + amount6 + ", amount7=" + amount7
				+ ", amount8=" + amount8 + ", amount9=" + amount9 + ", amount10=" + amount10 + ", amount11=" + amount11
				+ ", amount12=" + amount12 + ", amount13=" + amount13 + ", amount14=" + amount14 + ", amount15="
				+ amount15 + ", cgstAmt1=" + cgstAmt1 + ", cgstAmt2=" + cgstAmt2 + ", cgstAmt3=" + cgstAmt3
				+ ", cgstAmt4=" + cgstAmt4 + ", cgstAmt5=" + cgstAmt5 + ", cgstAmt6=" + cgstAmt6 + ", cgstAmt7="
				+ cgstAmt7 + ", cgstAmt8=" + cgstAmt8 + ", cgstAmt9=" + cgstAmt9 + ", cgstAmt10=" + cgstAmt10
				+ ", cgstAmt11=" + cgstAmt11 + ", cgstAmt12=" + cgstAmt12 + ", cgstAmt13=" + cgstAmt13 + ", cgstAmt14="
				+ cgstAmt14 + ", cgstAmt15=" + cgstAmt15 + ", sgstAmt1=" + sgstAmt1 + ", sgstAmt2=" + sgstAmt2
				+ ", sgstAmt3=" + sgstAmt3 + ", sgstAmt4=" + sgstAmt4 + ", sgstAmt5=" + sgstAmt5 + ", sgstAmt6="
				+ sgstAmt6 + ", sgstAmt7=" + sgstAmt7 + ", sgstAmt8=" + sgstAmt8 + ", sgstAmt9=" + sgstAmt9
				+ ", sgstAmt10=" + sgstAmt10 + ", sgstAmt11=" + sgstAmt11 + ", sgstAmt12=" + sgstAmt12 + ", sgstAmt13="
				+ sgstAmt13 + ", sgstAmt14=" + sgstAmt14 + ", sgstAmt15=" + sgstAmt15 + ", igstAmt1=" + igstAmt1
				+ ", igstAmt2=" + igstAmt2 + ", igstAmt3=" + igstAmt3 + ", igstAmt4=" + igstAmt4 + ", igstAmt5="
				+ igstAmt5 + ", igstAmt6=" + igstAmt6 + ", igstAmt7=" + igstAmt7 + ", igstAmt8=" + igstAmt8
				+ ", igstAmt9=" + igstAmt9 + ", igstAmt10=" + igstAmt10 + ", igstAmt11=" + igstAmt11 + ", igstAmt12="
				+ igstAmt12 + ", igstAmt13=" + igstAmt13 + ", igstAmt14=" + igstAmt14 + ", igstAmt15=" + igstAmt15
				+ ", totalBillPay=" + totalBillPay + ", parameterName1=" + parameterName1 + ", parameterName2="
				+ parameterName2 + ", parameterName3=" + parameterName3 + ", parameterName4=" + parameterName4
				+ ", parameterName5=" + parameterName5 + ", parameterName6=" + parameterName6 + ", parameterName7="
				+ parameterName7 + ", parameterName8=" + parameterName8 + ", parameterName9=" + parameterName9
				+ ", parameterName10=" + parameterName10 + ", parameterName11=" + parameterName11 + ", parameterName12="
				+ parameterName12 + ", parameterName13=" + parameterName13 + ", parameterName14=" + parameterName14
				+ ", parameterName15=" + parameterName15 + ", rebateAmount=" + rebateAmount + "]";
	}
}