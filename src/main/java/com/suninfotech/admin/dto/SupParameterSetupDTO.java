...
public class SupParameterSetupDTO implements Serializable {
	/**
	 * 
	 */
	...
	public String ratepersqft3;
	public String flatamount3;
	public String cb3;
	...
	public SupParameterSetupDTO() {
		super();
		// TODO Auto-generated constructor stub
	}

	public SupParameterSetupDTO(String id, String societycode, String address1, String address2, String address3,
			String highlightedfootnote, String bottomdesc, String bankDetail, String regCreditmonths,
			String regCreditdays, String regInttype, String regIntrate, String regPenalty, String regRebaterate,
			String regRebateamt, String regRebatedays, String authorisedsignatory, String billfrequency,
			String lastinvoiceno, String yeardays, String accountingyear, String parametershortname1,
			String parametername1, String ratepersqft1, String flatamount1, String cb1, String parametershortname2,
	...
	public String toString() {
		return "SupParameterSetupDTO [id=" + id + ", societycode=" + societycode + ", address1=" + address1
				+ ", address2=" + address2 + ", address3=" + address3 + ", highlightedfootnote=" + highlightedfootnote
				+ ", bottomdesc=" + bottomdesc + ", BankDetail=" + BankDetail + ", regCreditmonths=" + regCreditmonths
				+ ", regCreditdays=" + regCreditdays + ", regInttype=" + regInttype + ", regIntrate=" + regIntrate
				+ ", regPenalty=" + regPenalty + ", regRebaterate=" + regRebaterate + ", regRebateamt=" + regRebateamt
				+ ", regRebatedays=" + regRebatedays + ", authorisedsignatory=" + authorisedsignatory
				+ ", billfrequency=" + billfrequency + ", lastinvoiceno=" + lastinvoiceno + ", yeardays=" + yeardays
				+ ", accountingyear=" + accountingyear + ", parametershortname1=" + parametershortname1
				+ ", parametername1=" + parametername1 + ", ratepersqft1=" + ratepersqft1 + ", flatamount1="
				+ flatamount1 + ", cb1=" + cb1 + ", parametershortname2=" + parametershortname2 + ", parametername2="
				+ parametername2 + ", ratepersqft2=" + ratepersqft2 + ", flatamount2=" + flatamount2 + ", cb2=" + cb2
				...
				+ IntOnCreditPeriod + ", IntOnOPBal=" + IntOnOPBal + "]";
	}
