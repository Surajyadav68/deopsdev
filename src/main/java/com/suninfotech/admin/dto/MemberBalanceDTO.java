...
public MemberBalanceDTO(String id, String societyCode, String yearCode, String memberCode, String mainArrears,
...
public String toString() {
	return "MemberBalanceDTO [id=" + id + ", societyCode=" + societyCode + ", yearCode=" + yearCode + ", memberCode="
			+ memberCode + ", mainArrears=" + mainArrears + ", suppArrears=" + suppArrears + ", mainIntArr="
			+ mainIntArr + ", suppIntArr=" + suppIntArr + ", creditAmt=" + creditAmt + ", disputedAmt=" + disputedAmt
			+ "]";
}
	}